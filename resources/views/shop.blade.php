...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
                    ...
                    <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0 pt-3">
                            <ul class="list list-inline mb-0">
                                ...
                                <li class="list-item"><a href="#" class="menu-link py-1">{{$category->name}}</a></li>
                                @endforeach
                                {{-- <li class="list-item">
        ...
        <div class="shop-list flex-grow-1">
            <div class="swiper-container js-swiper-slider slideshow slideshow_small slideshow_split" data-settings='{ "autoplay": { "delay": 5000 },
            "slidesPerView": 1,
            "effect": "fade",
            "loop": true,
                            ...
                            <div class="slide-split_text position-relative d-flex align-items-center"
                                ...
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2
                                        ...
                                        Girl's <br /><strong>ACCESSORIES</strong></h2>
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{route('shop.product.details', ['product_slug'=>$product->slug])}}"><img
                                                loading="lazy" src="{{asset('uploads/products')}}/{{$product->image}}"
                                                width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                                    </div>
                                    @foreach (explode(',', $product->images) as $image)
                                    <div class="swiper-slide">
                                        <a href="{{route('shop.product.details', ['product_slug'=>$product->slug])}}"><img
                                                loading="lazy" src="{{asset('uploads/products/'.$image)}}" width="330"
                            ...
                            <a href="{{route('cart.index')}}"
                                class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside btn-warning mb-3">
                                Go to Cart</a>
                            @else
