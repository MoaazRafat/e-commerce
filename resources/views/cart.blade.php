    ...
    <div class="shopping-cart">
      ...
      <div class="cart-table__wrapper">
        ...
        <div>
          ...
          <p class="alert text-success" style="color:#278c04 !important;">{{Session::get('success')}}</p>
          @elseif (Session::has('error'))
          <p class="alert text-danger" style="color:#f90505 !important;">{{Session::get('error')}}</p>
          @endif
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center pt-5 bp-5">
          <h2 class="text-uppercase fw-bold">Your cart is empty</h2>
          <p class="text-secondary">You haven't added any items to your cart yet.</p>
          <a href="{{route('shop.index')}}" class="btn btn-primary btn-checkout">GO TO SHOP</a>
        </div>
      </div>
      @endif
    </div>
