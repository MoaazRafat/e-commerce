                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardData[0]->TotalOrdered}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardData[0]->TotalDelivered}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardData[0]->TotalAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardData[0]->TotalOrderedAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardData[0]->TotalDeliveredAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="wg-table table-all-user">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th style="width: 80px" class="text-center">OrderNo</th>
