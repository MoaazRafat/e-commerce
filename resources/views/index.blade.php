      ...
      <div class="position-relative">
        <div class="swiper-container js-swiper-slider" data-settings='{
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('uploads/categories')}}/{{$category->image}}"
                ...
                <div class="swiper-slide product-card product-card_style3">
                  <div class="pc__img-wrapper">
                    <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}">
                      ...
                      <img loading="lazy" src="{{ asset('uploads/products/'.$image)}}" width="258" height="313"
                    ...
                    <h6 class="pc__title"><a
                      ...
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">
                          <s>${{$product->regular_price}}</s> ${{$product->sale_price}}</span>
                      </div>
                      {{-- <div
